...
// Dynamic font sizes
const _small = computed(() => `${settings.fontSizesComputed.value.bodyVerySmall}px`)
const _h2 = computed(() => `${settings.fontSizesComputed.value.h2}px`)
const _h4 = computed(() => `${settings.fontSizesComputed.value.h4}px`)
...
<template>
  <!-- Compact Header -->
  <div class="bg-gradient-to-r from-indigo-100 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 border-b border-blue-200 dark:border-gray-900">
