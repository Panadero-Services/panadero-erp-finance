...
const props = defineProps({
  ...
  // Size variants to match SharedButton
  size: {
    type: String,
    default: 'normal',
  ...
  // Variant/theme to match SharedButton
  variant: {
    type: String,
    default: 'outline',
    validator: (value) => [
...
const variantClasses = {
  outline: 'shared-dropdown--outline',
  filled: 'shared-dropdown--filled',
  ghost: 'shared-dropdown--ghost'
};

const sizeClasses = {
  small: {
    container: 'shared-dropdown--small',
    icon: 'h-3 w-3'
  },
  normal: {
    container: 'shared-dropdown--normal',
    icon: 'h-4 w-4'
  },
  large: {
    container: 'shared-dropdown--large',
    icon: 'h-5 w-5'
  }
};
...
<template>
  ...
  >
    ...
    <button
      ...
      :class="[
        'shared-dropdown group',
        variantClasses[variant],
        sizeClasses[size].container,
        {
          'shared-dropdown--disabled': disabled,
          'shared-dropdown--full-width': fullWidth,
          'shared-dropdown--open': isOpen
        }
      ]"
...
/* Size variants - matching SharedButton */
.shared-dropdown--small {
...
/* Variant styles */
.shared-dropdown--outline {
  background-color: transparent !important;
  border: 2px solid #6366f1 !important;
  color: #6366f1 !important;
}

.shared-dropdown--outline:hover {
  background-color: rgba(99, 102, 241, 0.05) !important;
  border-color: #4f46e5 !important;
  color: #4f46e5 !important;
}

.shared-dropdown--outline:focus {
  @apply ring-indigo-500;
}

.dark .shared-dropdown--outline {
  border-color: #60a5fa !important;
  color: #60a5fa !important;
}

.dark .shared-dropdown--outline:hover {
  background-color: rgba(96, 165, 250, 0.05) !important;
  border-color: #3b82f6 !important;
  color: #3b82f6 !important;
}

.shared-dropdown--filled {
...
.shared-dropdown--outline.shared-dropdown--open {
  @apply ring-indigo-500;
}

/* Dark mode focus ring adjustments */
.dark .shared-dropdown:focus {
