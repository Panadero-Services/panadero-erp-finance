...
export interface ISpreadsheetConfig {
    ...
    formats?: IFormats[];
    /** @deprecated set inside your data instead. Example: data ={sheets: [{name: "Sheet 1", ..., freeze: {col: "A", row: 1}}]} */
    leftSplit?: number;
    /** @deprecated set inside your data instead. Example: data ={sheets: [{name: "Sheet 1", ..., freeze: {col: "A", row: 1}}]} */
    topSplit?: number;
...
export type IMuonCell = [number, number, ICellMeta];
export type ToolbarBlocks = "default" | "undo" | "colors" | "columns" | "rows" | "cell" | "lock" | "align" | "decoration" | "clear" | "help" | "format" | "actions" | "file";
...
export interface ISpreadsheet {
    ...
    /** @deprecated use sheets.clear(id) instead */
    clearSheet: (id?: string) => void;
    /** @deprecated use sheets.remove(id) instead */
    removeSheet: (id: string) => void;
    /** @deprecated use sheets.add(id) instead */
    addSheet: (name?: string) => string;
    /** @deprecated use sheets.getAll() instead */
    getSheets: () => ISheet[];
    /** @deprecated use sheets.getActive() instead */
    getActiveSheet: () => ISheet;
    /** @deprecated use sheets.setActive(id) instead */
...
export declare enum SpreadsheetServiceEvents {
    updateGridState = "updateGridState",
    updateGridSizes = "updateGridSizes",
    redraw = "redraw",
    recalculate = "recalculate",
    setGridWidgetFocus = "setGridWidgetFocus",
    applyFilter = "applyFilter",
    setSelectedCell = "setSelectedCell",
    removeSearchCell = "removeSearchCell",
    setSearchedArray = "setSearchedArray",
    setSearchedCell = "setSearchedCell",
...
export type IMerged = Map<string, ISpan>;
...
export interface ISpanFromParse {
    from: {
        row: number;
        column: number;
    };
