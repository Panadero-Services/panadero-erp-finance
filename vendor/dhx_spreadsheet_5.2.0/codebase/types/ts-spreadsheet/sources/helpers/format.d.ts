import { IFormats, ISpreadsheetConfig, ILocalization } from "../types";
import { ITreeCollection } from "../../../ts-data";
import { Store } from "./math";
type FDict = Record<string, IFormats>;
export declare const formatsById: FDict;
export declare const formatsByMask: FDict;
...
export declare function initFormat(config: ISpreadsheetConfig, localization: ILocalization): void;
