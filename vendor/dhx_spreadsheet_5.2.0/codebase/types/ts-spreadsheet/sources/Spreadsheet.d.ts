...
import { FileFormat, ICellInfo, Id, IDataWithStyles, IFormats, ISelection, ISheet, ISpreadsheet, ISpreadsheetConfig, IStylesList, SpreadsheetEvents, ILink, IFilterRules, IFilter, IMerged } from "./types";
...
export declare class Spreadsheet extends View implements ISpreadsheet {
    ...
    _parseCells(data: any, page: DataPage, multilineClasses: string[], cell2span: IMerged, lastChunk?: boolean): void;
    serialize(): {
        sheets: any[];
        styles: {};
        formats: IFormats[];
    ...
    private _setServiceEventsHandlers;
