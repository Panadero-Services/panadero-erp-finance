    ...
    function render(whoIs='black',whoIsNot='white'){
        ...
        for (var y=0; y<RL; y++){
            for (var x=0; x<RL; x++){
                ...
                ctx.arc(x*VG+VG/2,y*VG+VG/2,8,0,Math.PI*2);
                ctx.fill();
            }        
...
//alert('In this special Othello100-version: Enigma:) the goal is to fill ALL FIELDS, black or white. Crack the Code!!!');
}
...
<template>
    <div class=" ml-4 scale-90">
        <canvas :id="'othello'+id" width="260" height="220"></canvas> 
    </div>
    
    <footer>
        <div id="footerOthello"></div>
    </footer>
</template>