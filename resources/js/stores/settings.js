...
export let useSettingsStore = defineStore('settings',{
    state: () => ({
        ...
        mode: {first:false, noob:true, full:false, advanced:false, dev:false},
        dark: false,
  ...
  //      animate: true,
        ...
        project: {id:0, title:"none", validTitles:['none', 'demo', 'learn'], path:"none", environment:'none', validEnvironments:[], category:'none'},
