            ...
            <div class=" overflow-y-scroll h-32 mt-2">
               <div class="ml-2 flex flex-wrap ">
                  <div v-for="_project in _projects" class="">
                     <div>
                        <button type="button"  @click="_setProject(_project.title)" class="m-1 inline-flex items-center rounded-md px-2.5 py-1 text-xxs font-medium ring-1 ring-inset dark:hover:ring-indigo-400 hover:ring-black " :class="_actualProject==_project.title ? _activeLabel : _inActiveLabel">{{_project.title}}</button>
                     </div>
                  </div>
               </div>
            </div>
