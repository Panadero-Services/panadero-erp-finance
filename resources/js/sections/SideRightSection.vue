                    ...
                    <div class="flex flex-1 flex-col justify-between">
                      <div class="divide-y divide-gray-200 px-4 sm:px-6">
                        <div class="space-y-6 pb-5 pt-6">
                          <div>
                            <label for="project-name" class="block text-sm/6 font-medium text-gray-900">Project title</label>
                            <div class="mt-2">
                              <input :value="set.project.title" type="text" name="project-title" id="project-title" class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6" />
                            </div>
                            
                            <label for="project-name" class="block text-sm/6 font-medium text-gray-900 mt-3">Environment</label>
                            <div class="mt-2">
                              <input :value="set.project.environment" type="text" name="project-environment" id="project-environment" class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6" />
                            </div>

                            <label for="project-name" class="block text-sm/6 font-medium text-gray-900 mt-3">Category</label>
                            <div class="mt-2">
