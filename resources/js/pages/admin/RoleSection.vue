            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
              ...
              <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                <tr v-for="user in users" :key="user.id" class="hover:bg-gray-50 dark:hover:bg-gray-800/50">
                  ...
                  <!-- Roles Column -->
                  <td class="py-1 px-2 text-sm w-[50%]">
                    <div class="flex flex-wrap gap-0.5">
                      <div v-for="role in user.roles" 
                           :key="typeof role === 'object' ? role.id : role"
                           class="inline-flex items-center rounded-full px-1.5 py-0.5 text-[10px] leading-3 font-medium ring-1 ring-inset"
            ...
            <div class="p-4">
              ...
              <div class="mt-3 space-y-2">
                <div v-for="role in sortRoles(availableRoles)" :key="role.id" 
                  ...
                  <div class="inline-flex items-center rounded-full p-0.5 text-[10px] leading-3 font-medium ring-1 ring-inset"
...
const roleStyles = {
  master: 'bg-purple-100 dark:bg-purple-900/30 text-purple-800 dark:text-purple-200 border border-purple-200 dark:border-purple-700',
  admin: 'bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-200 border border-red-200 dark:border-red-700',
  developer: 'bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-200 border border-blue-200 dark:border-blue-700',
  editor: 'bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-200 border border-green-200 dark:border-green-700',
  member: 'bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200 border border-gray-200 dark:border-gray-600'
};
...
const getRoleClasses = (role) => {
  ...
  const classes = {
    'master': 'bg-purple-50 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 ring-purple-700/10 dark:ring-purple-400/30',
    'admin': 'bg-red-50 dark:bg-red-900/30 text-red-700 dark:text-red-300 ring-red-700/10 dark:ring-red-400/30',
    'developer': 'bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 ring-blue-700/10 dark:ring-blue-400/30',
    'editor': 'bg-green-50 dark:bg-green-900/30 text-green-700 dark:text-green-300 ring-green-700/10 dark:ring-green-400/30',
    'member': 'bg-gray-50 dark:bg-gray-700 text-gray-600 dark:text-gray-300 ring-gray-500/10 dark:ring-gray-400/30'
  };
