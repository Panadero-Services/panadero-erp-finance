...
// sections
//import RecordCardDefault from '@/layouts/cards/RecordCardDefault.vue';
   ...
   <AppToolbarLayout :title="page.title" :baseSections="baseSections" :set="_set" :contract="_contract" :page="page">
      <template #header>
         ...
         <div v-if="editRecordMode" class="col-span-2 md:col-span-1 mt-4 sm:mt-12 lg:mt-16 mx-4 sm:mx-6 lg:mx-8">
            ...
            <!--  HERE COMES THE NEW EditRecordDefault
            <edit-record-default lng='en' 
                                :key="keyIndex"
      ...
      <template #default>
         <div id="projects" class="w-full ... min-h-4 min-w-full ">
            <div class="grid md:grid-cols-2 xl:grid-cols-3 gap-4">
                ...
                <!--  HERE COMES THE NEW RecordCardDefault
                  <div v-for="record in records.data" key="record.id" class="text-sm">
                      <RecordCardDefault :record="record" :module="_module" :table="_table" @edit="_whatever" :db="_db"/>
                  </div>
                -->
