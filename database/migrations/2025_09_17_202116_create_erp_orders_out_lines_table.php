<?php
// 2025_09_17_202116_create_erp_orders_out_lines_table.php
...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasTable('erp_order_out_lines')) {
            Schema::create('erp_order_out_lines', function (Blueprint $table) {
                $table->id();
                $table->foreignId('order_out_id')->constrained('erp_orders_out')->onDelete('cascade');
                ...
                $table->index(['order_out_id', 'is_active']);
    ...
    {
        Schema::dropIfExists('erp_order_out_lines');
    }
};