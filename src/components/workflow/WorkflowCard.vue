...
<template>
  <div 
    class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded-lg p-6 hover:border-blue-300 dark:hover:border-blue-500 hover:shadow-md transition-all"
    ...
    <div class="mt-4 pt-3 border-t border-gray-200 dark:border-gray-600">
      ...
      <slot name="actions">
        <!-- Default action hint -->
        <div v-if="clickable" :style="{ fontSize: `${store.fontSizes.base - 2}px` }" class="text-gray-500 dark:text-gray-400 text-center">
          <i class="fas fa-mouse-pointer mr-1"></i>
          Click to start workflow
        </div>
        <!-- No action hint when not clickable -->
        <div v-else :style="{ fontSize: `${store.fontSizes.base - 2}px` }" class="text-gray-500 dark:text-gray-400 text-center">
